...
function updataStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepComplete = false;
      time.innerHTML = moment__WEBPACK_IMPORTED_MODULE_0___default()(order.updatedAt).format('hh:mm A , Do MMMM');
...
if (adminAreaPath.includes('admin')) {
  (0,_admin_admin__WEBPACK_IMPORTED_MODULE_1__.initAdmin)(socket);
